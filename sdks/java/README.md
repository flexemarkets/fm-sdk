...
>
> Pin an exact `<version>` rather than a range, read the
...
<dependency>
    ...
    <version>0.3.3</version><!-- fm-readme-version -->
</dependency>
```
...
```kotlin
implementation("com.flexemarkets:fm-sdk:0.3.3") // fm-readme-version
```
