...
set of fields out. They say nothing about what OrderBook and Trades do with a
...
from fm.orderbook import OrderBook
...
AGGREGATORS = {"OrderBook": OrderBook, "Trades": Trades}
...
def _check_order_book(book: OrderBook, expect: dict[str, Any]) -> None:
    readers = {
...
CHECKS = {"OrderBook": _check_order_book, "Trades": _check_trades}
